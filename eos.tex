...
To date there have been few sensitivity studies of hte impact of the EoS on hydroynamics simulaion results.  They have been limited to studies the order of the phase transition~ \cite{Huovinen:2005gy}, different parameterization schemes for the LQCD EoS ~\cite{Huovinen:2009yb}, and data driven Bayesian techniques to determine the EoS parameters motivated by LQCD EoS calculations~\cite{Pratt:2015vb}.  
